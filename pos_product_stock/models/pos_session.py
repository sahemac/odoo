...
class PosSession(models.Model):
    ...
    def _loader_params_stock_quant(self):
        """Load some fields with a certain domain of stock.quant in session."""
        ...
        return {
            'search_params': {
                'domain': domain,
                'fields': ['product_id', 'available_quantity', 'quantity', 'location_id'],
            },
        }
    ...
    def _loader_params_stock_move_line(self):
        ...
        return {
            'search_params': {
                'fields': ['product_id', 'location_dest_id', 'quantity', 'location_id'],
            },
        }
